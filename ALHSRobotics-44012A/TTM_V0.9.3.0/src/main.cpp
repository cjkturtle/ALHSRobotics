  ...
  while (true) {
    ...
    ********************************************************************/
    ...
    if(fabs(JRX) > t || fabs(JRY) > t || fabs(JLX) > t){
      ...
      RB.spin(vex::directionType::fwd, ((JRY - JRX) / 2) * Speed, vex::velocityUnits::pct);
    ...
    ********************************************************************/
    if(Controller.ButtonL1.pressing()){
      Swing.spin(vex::directionType::fwd)
      }     
    ...
    if(Beta){
      ...
      if (ScreenStatus == -1){
        ...
        Controller.Screen.print("LF: %1.0f", LF.temperature(vex::percentUnits::pct));
        Controller.Screen.newLine();
        Controller.Screen.print("LB: %1.0f", LB.temperature(vex::percentUnits::pct));
        Controller.Screen.newLine();
        Controller.Screen.print("RF: %1.0f", RF.temperature(vex::percentUnits::pct));
      ...
      Brain.Screen.printAt(2, 20, "LF Temp: %1.0f" " Percent", LF.temperature(vex::percentUnits::pct));
      Brain.Screen.printAt(2, 40, "LB Temp: %1.0f" " Percent", LB.temperature(vex::percentUnits::pct));   
      Brain.Screen.printAt(2, 60, "RF Temp: %1.0f" " Percent", RF.temperature(vex::percentUnits::pct));
      Brain.Screen.printAt(2, 80, "RB Temp: %1.0f" " Percent", RB.temperature(vex::percentUnits::pct)); 
      ...
      Brain.Screen.printAt(2, 180, "Program: TTM V0.9.3.2");
