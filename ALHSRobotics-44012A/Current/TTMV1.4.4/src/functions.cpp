...
void MainScreen(){ 
  ...
  Brain.Screen.printAt(2, 160, "Program: TTM V1.4.2");
...
void SwingDown(){
  Swing.spin(vex::directionType::rev, 100*traySpeed, vex::velocityUnits::pct); //test dir
}
...
void AutonSelector(){
  ...
  Brain.Screen.printAt(200,200, "Auton Selection: None");
  ...
  if((xPressPos <= 2) && (xPressPos >= 60) && (yPressPos <= 2) && (yPressPos >= 40)){
    autonStatus = 1;
    AutonSelectorScreenInit();
    Brain.Screen.printAt(80,200, "Auton Selection: Blue Left");
  }
  else if((xPressPos <= 2) && (xPressPos >= 60) && (yPressPos <= 62) && (yPressPos >= 102)){
    autonStatus = 2;
    AutonSelectorScreenInit();
    Brain.Screen.printAt(80,200, "Auton Selection: Blue Right");
  }
   else if((xPressPos <= 2) && (xPressPos >= 60) && (yPressPos <= 122) && (yPressPos >= 162)){
    autonStatus = 3;
    AutonSelectorScreenInit();
    Brain.Screen.printAt(80,200, "Auton Selection: Red Left");
  }
  else if((xPressPos <= 2) && (xPressPos >= 60) && (yPressPos <= 182) && (yPressPos >= 222)){
    autonStatus = 4;
    AutonSelectorScreenInit();
    Brain.Screen.printAt(80,200, "Auton Selection: Red Right");
  }
  else{
