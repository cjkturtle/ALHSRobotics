...
8. Multiple autonomous programs are avaibable to choose from for each starting field position.
...
Right Bumper top - intake
Right bumper bottom - reverse intake

A - DropStack();
Left Bumper top - Swing Up | Pushing
Left Bumper bottom - Swing Down | Pushing 
X - Swing to location 0 | Push
Y - Swing to location 1 | Push

Up Arrow - 100% Speed | Toggle 
Down Arrow - 33% Speed | Toggle
Right Arrow && Left Arrow - Normal Speed | Toggle