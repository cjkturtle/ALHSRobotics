...
int visionStatus = 0;
int gameStatus;
bool swingStatus = true; // Replace with sensor value.
bool r4bStatus = true; // Replace with sensor value.
...
void MainScreen(){ 
  ...
  Brain.Screen.printAt(2, 160, "Program: TTM V1.3.0");
