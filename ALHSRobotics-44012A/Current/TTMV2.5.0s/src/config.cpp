...
vex::vision::signature P = vex::vision::signature (2, 1801, 3277, 2539, 4831, 7119, 5975, 3.8, 0);
vex::vision::signature O = vex::vision::signature (3, 6471, 9595, 8033, -1741, -1027, -1384, 4.5, 0);
vex::vision::signature RG = vex::vision::signature (4, 6645, 7739, 7192, -1189, -599, -894, 3, 0);
...
vex::vision Vision1 = vex::vision (vex::PORT5, 50, G, P, O, RG, SIG_5, SIG_6, N);