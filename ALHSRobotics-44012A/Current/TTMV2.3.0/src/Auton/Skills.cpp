...
void Skills(){
  ...
  Brain.Screen.printAt(151, 100, "File: TTM_V2.3.0s");
  ...
  DistMove(21, 40); // Move forward 24 inches
  VirtualField(); // Print updated location to virtual field
  IntakesMove(1); // Turn on intakes
  DistMove(6, 20); // Keep moving 6 more inches
  VirtualField(); // Print updated location to virtual field
  Sleep(250); // Wait 0.25 seconds
  IntakesMove(0); // Turn off intakes

  DistMove(6, -40); // Move backward 6 inches
  VirtualField(); // Print updated location to virtual field
  Sleep(200);
  DegTurn(210, 20); // Turn right 200 degrees
  VirtualField(); // Print updated location to virtual field
  DistMove(4, -40); // Move backward 3 inches
  VirtualField(); // Print updated location to virtual field
  IntakesMove(1); // Turn on intakes
  ...
  DistMove(2.5, 40); // Move forward 3 inches
  VirtualField(); // Print updated location to virtual field

  DegTurn(-100, 20); // Turn left 90 degrees
  VirtualField(); // Print updated location to virtual field
  IntakesMove(1); // Turn on intakes

  DistMove(13, 15); // Move forward 12 inches
  IntakesStop(); // Stop the intakes
  Sleep(200);
  DistMove(23, -30); // Move backward 12 inches
  VirtualField(); // Print updated location to virtual field

  DegTurn(90, 20); // Turn right 90 degrees
  VirtualField(); // Print updated location to virtual field
  //Brain.resetTimer(); 
