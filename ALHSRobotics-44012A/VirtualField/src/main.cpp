...
void FieldTemplate(){
  ...
  void RobotTemplate(double preMidX, double preMidY, double deg){
    ...
    double midX = preMidX+3;
    double midY = preMidY+3;
   //Brain.Screen.drawRectangle(currentX+6, currentY, 4, 4);
    float rotatedeg = ((deg + 180)*3.1415926545)/180;
    ...
    //int newCurrentX1 = currentX1*(midX*cos(rotatedeg));
    ...
    //Brain.Screen.setPenColor(purple);
    //Brain.Screen.drawLine(newCurrentX1 + 8, newCurrentY1 - 5, newCurrentX1 + 8, newCurrentY1 + 5);
    //Brain.Screen.drawLine(newCurrentX1 + 10, newCurrentY1 - 5, newCurrentX1 + 10, newCurrentY1 + 5);
