...
limit SwingHome = vex::limit(Brain.ThreeWirePort.A);
limit IntakeTop = vex::limit(Brain.ThreeWirePort.B);
gyro Gyro = vex::gyro(Brain.ThreeWirePort.C);
accelerometer AccelX = vex::accelerometer(Brain.ThreeWirePort.D);
accelerometer AccelY = vex::accelerometer(Brain.ThreeWirePort.E);
